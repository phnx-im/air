...
use aircommon::crypto::{aead::keys::IdentityLinkWrapperKey, indexed_aead::keys::UserProfileKey};
use airprotos::client::{group::GroupData, virtual_client::VIRTUAL_CLIENT_KP_UPLOAD_COMPONENT_ID};
use anyhow::Context;
use tracing::warn;
...
impl CoreUser {
    #[expect(dead_code)]
    pub(crate) async fn ensure_self_group(&self) -> anyhow::Result<Group> {
