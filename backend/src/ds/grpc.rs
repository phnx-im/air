...
use aircommon::{
    ...
    messages::client_ds::{
        self, GroupOperationParams, QsQueueMessagePayload, UserProfileKeyUpdateParams,
    },
        ...
        let timestamp = self
            .update_apq_group_state_without_verification(
                ...
                async |t_group_state, pq_group_state, t_message, pq_message| {
                    ...
                    let message = DsGroupState::apq_join_connection_group(
                        t_group_state,
                        pq_group_state,
                        t_message,
                        pq_message,
                    ...
                    let payload = QsQueueMessagePayload::apq_mls_message(timestamp, message);
