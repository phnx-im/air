...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -408503705;
...
111 => wire__crate__api__user_cubit__UserCubitBase_upload_logs_impl(port, ptr, rust_vec_len, data_len),
...
148 => wire__crate__api__user_cubit__debug_logs_download_info_default_impl(port, ptr, rust_vec_len, data_len),
