...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -2103603846;
...
157 => wire__crate__api__linked_devices_cubit__linked_devices_state_default_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__user_settings_cubit__load_user_settings_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__member_details_cubit__member_details_state_default_impl(port, ptr, rust_vec_len, data_len),
160 => wire__crate__api__markdown__message_content_error_impl(port, ptr, rust_vec_len, data_len),
161 => wire__crate__api__markdown__message_content_parse_markdown_impl(port, ptr, rust_vec_len, data_len),
163 => wire__crate__api__message_list_cubit__message_list_state_default_impl(port, ptr, rust_vec_len, data_len),
164 => wire__crate__api__multi_device__multi_device_link_client_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__multi_device__multi_device_provision_client_impl(port, ptr, rust_vec_len, data_len),
166 => wire__crate__api__notification_context__notification_policy_default_impl(port, ptr, rust_vec_len, data_len),
167 => wire__crate__api__logging__read_app_logs_impl(port, ptr, rust_vec_len, data_len),
168 => wire__crate__api__logging__read_background_logs_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__utils__read_clipboard_file_paths_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__utils__read_clipboard_image_impl(port, ptr, rust_vec_len, data_len),
171 => wire__crate__api__logging__tar_logs_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        162 => wire__crate__api__markdown__message_content_parse_markdown_raw_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        173 => wire__crate__api__username_suggestions__username_from_display_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
