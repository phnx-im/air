...
//!
//! A deployment can require a sign-up to answer a challenge, either always or
//! once its signup counters cross a threshold. The flow asks what is needed
//! before it draws its steps, and handles being told a challenge is needed
//! after all, since the answer can change in between.

use aircommon::identifiers::Fqdn;
pub(crate) use aircommon::registration::{ChallengeKind, RegistrationChallenge, RegistrationInfo};
