  ...
  group('YouScreenTest', () {
    ...
    testWidgets('renders correctly (no handles)', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/you_screen_no_handles.png'),
      );
    });
    ...
    testWidgets('renders correctly (some handles)', (tester) async {
      ...
      await expectLater(
        find.byType(MaterialApp),
        matchesGoldenFile('goldens/you_screen_some_handles.png'),
      );
    });
    ...
    testWidgets('renders correctly (all handles)', (tester) async {
      ...
      await expectLater(
        find.byType(MaterialApp),
        matchesGoldenFile('goldens/you_screen_all_handles.png'),
      );
    });
