...
mixin _$AirFeatures {
 ...
 bool get encryptedGroupProfiles; bool get emptyConnectionGroupAttributes; bool get pqGroups; bool get groupProfileComponent;
...
int get hashCode {
  final _this = this as AirFeatures;
  return Object.hash(runtimeType,_this.encryptedGroupProfiles,_this.emptyConnectionGroupAttributes,_this.pqGroups,_this.groupProfileComponent);
}

@override
String toString() {
  final _this = this as AirFeatures;
  return 'AirFeatures(encryptedGroupProfiles: ${_this.encryptedGroupProfiles}, emptyConnectionGroupAttributes: ${_this.emptyConnectionGroupAttributes}, pqGroups: ${_this.pqGroups}, groupProfileComponent: ${_this.groupProfileComponent})';
}
...
@useResult
$Res call({
 bool encryptedGroupProfiles, bool emptyConnectionGroupAttributes, bool pqGroups, bool groupProfileComponent
});
...
/// Create a copy of AirFeatures
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? encryptedGroupProfiles = null,Object? emptyConnectionGroupAttributes = null,Object? pqGroups = null,Object? groupProfileComponent = null,}) {
...
as bool,groupProfileComponent: null == groupProfileComponent ? _self.groupProfileComponent : groupProfileComponent // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _AirFeatures implements AirFeatures {
  const _AirFeatures({required this.encryptedGroupProfiles, required this.emptyConnectionGroupAttributes, required this.pqGroups, required this.groupProfileComponent});
  

@override final  bool encryptedGroupProfiles;
@override final  bool emptyConnectionGroupAttributes;
@override final  bool pqGroups;
@override final  bool groupProfileComponent;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _AirFeatures&&(identical(other.encryptedGroupProfiles, encryptedGroupProfiles) || other.encryptedGroupProfiles == encryptedGroupProfiles)&&(identical(other.emptyConnectionGroupAttributes, emptyConnectionGroupAttributes) || other.emptyConnectionGroupAttributes == emptyConnectionGroupAttributes)&&(identical(other.pqGroups, pqGroups) || other.pqGroups == pqGroups)&&(identical(other.groupProfileComponent, groupProfileComponent) || other.groupProfileComponent == groupProfileComponent));
}


@override
int get hashCode {
    return Object.hash(runtimeType,encryptedGroupProfiles,emptyConnectionGroupAttributes,pqGroups,groupProfileComponent);
}

@override
String toString() {
    return 'AirFeatures(encryptedGroupProfiles: $encryptedGroupProfiles, emptyConnectionGroupAttributes: $emptyConnectionGroupAttributes, pqGroups: $pqGroups, groupProfileComponent: $groupProfileComponent)';
}
...
/// Create a copy of AirFeatures
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? encryptedGroupProfiles = null,Object? emptyConnectionGroupAttributes = null,Object? pqGroups = null,Object? groupProfileComponent = null,}) {
...
$UiMessageCopyWith<$Res> get message;$UiInReplyToMessageCopyWith<$Res>? get inReplyToMessage;
...
@override
@pragma('vm:prefer-inline')
$UiInReplyToMessageCopyWith<$Res>? get inReplyToMessage {
    if (_self.inReplyToMessage == null) {
    return null;
  }

  return $UiInReplyToMessageCopyWith<$Res>(_self.inReplyToMessage!, (value) {
    return _then(_self.copyWith(inReplyToMessage: value));
  });
}
}
...
@override $UiMessageCopyWith<$Res> get message;@override $UiInReplyToMessageCopyWith<$Res>? get inReplyToMessage;
...
/// @nodoc
class $UiInReplyToMessageCopyWith<$Res>  {
$UiInReplyToMessageCopyWith(UiInReplyToMessage _, $Res Function(UiInReplyToMessage) __);
}
...
class UiInReplyToMessage_NotFound extends UiInReplyToMessage {
  const UiInReplyToMessage_NotFound(): super._();
...
class UiInReplyToMessage_Resolved extends UiInReplyToMessage {
  const UiInReplyToMessage_Resolved({required this.messageId, required this.sender, required this.mimiContent}): super._();
  

 final  MessageId messageId;
 final  UiUserId sender;
 final  UiMimiContent mimiContent;

/// Create a copy of UiInReplyToMessage
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UiInReplyToMessage_ResolvedCopyWith<UiInReplyToMessage_Resolved> get copyWith => _$UiInReplyToMessage_ResolvedCopyWithImpl<UiInReplyToMessage_Resolved>(this, _$identity);
...
/// @nodoc
abstract mixin class $UiInReplyToMessage_ResolvedCopyWith<$Res> implements $UiInReplyToMessageCopyWith<$Res> {
  factory $UiInReplyToMessage_ResolvedCopyWith(UiInReplyToMessage_Resolved value, $Res Function(UiInReplyToMessage_Resolved) _then) = _$UiInReplyToMessage_ResolvedCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UiInReplyToMessage_ResolvedCopyWithImpl<$Res>
    implements $UiInReplyToMessage_ResolvedCopyWith<$Res> {
  _$UiInReplyToMessage_ResolvedCopyWithImpl(this._self, this._then);

  final UiInReplyToMessage_Resolved _self;
  final $Res Function(UiInReplyToMessage_Resolved) _then;

/// Create a copy of UiInReplyToMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? messageId = null,Object? sender = null,Object? mimiContent = null,}) {
  return _then(UiInReplyToMessage_Resolved(
...
/// Create a copy of UiMessageDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? editingId = freezed,Object? inReplyTo = freezed,Object? updatedAt = null,Object? isCommitted = null,}) {
...
mixin _$UiReaction {
 ...
 String get emoji; List<UiUserId> get users;
/// Create a copy of UiReaction
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UiReactionCopyWith<UiReaction> get copyWith => _$UiReactionCopyWithImpl<UiReaction>(this as UiReaction, _$identity);
...
/// @nodoc
abstract mixin class $UiReactionCopyWith<$Res>  {
  factory $UiReactionCopyWith(UiReaction value, $Res Function(UiReaction) _then) = _$UiReactionCopyWithImpl;
@useResult
$Res call({
 String emoji, List<UiUserId> users
});
...
/// @nodoc
class _$UiReactionCopyWithImpl<$Res>
    implements $UiReactionCopyWith<$Res> {
  _$UiReactionCopyWithImpl(this._self, this._then);

  final UiReaction _self;
  final $Res Function(UiReaction) _then;
...
@override final  String emoji;
 final  List<UiUserId> _users;
@override List<UiUserId> get users {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UiReactionCopyWith<_UiReaction> get copyWith => __$UiReactionCopyWithImpl<_UiReaction>(this, _$identity);
...
/// @nodoc
abstract mixin class _$UiReactionCopyWith<$Res> implements $UiReactionCopyWith<$Res> {
  factory _$UiReactionCopyWith(_UiReaction value, $Res Function(_UiReaction) _then) = __$UiReactionCopyWithImpl;
@override @useResult
$Res call({
 String emoji, List<UiUserId> users
});
...
/// @nodoc
class __$UiReactionCopyWithImpl<$Res>
    implements _$UiReactionCopyWith<$Res> {
  __$UiReactionCopyWithImpl(this._self, this._then);

  final _UiReaction _self;
  final $Res Function(_UiReaction) _then;

/// Create a copy of UiReaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? emoji = null,Object? users = null,}) {
  return _then(_UiReaction(
emoji: null == emoji ? _self.emoji : emoji // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
class $UiSystemMessageCopyWith<$Res>  {
$UiSystemMessageCopyWith(UiSystemMessage _, $Res Function(UiSystemMessage) __);
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UiSystemMessage_AcceptedConnectionRequestCopyWith<UiSystemMessage_AcceptedConnectionRequest> get copyWith => _$UiSystemMessage_AcceptedConnectionRequestCopyWithImpl<UiSystemMessage_AcceptedConnectionRequest>(this, _$identity);
...
/// @nodoc
abstract mixin class $UiSystemMessage_AcceptedConnectionRequestCopyWith<$Res> implements $UiSystemMessageCopyWith<$Res> {
...
/// @nodoc
class _$UiSystemMessage_AcceptedConnectionRequestCopyWithImpl<$Res>
    implements $UiSystemMessage_AcceptedConnectionRequestCopyWith<$Res> {
  _$UiSystemMessage_AcceptedConnectionRequestCopyWithImpl(this._self, this._then);

  final UiSystemMessage_AcceptedConnectionRequest _self;
  final $Res Function(UiSystemMessage_AcceptedConnectionRequest) _then;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UiSystemMessage_ReceivedConnectionConfirmationCopyWith<UiSystemMessage_ReceivedConnectionConfirmation> get copyWith => _$UiSystemMessage_ReceivedConnectionConfirmationCopyWithImpl<UiSystemMessage_ReceivedConnectionConfirmation>(this, _$identity);
...
/// @nodoc
abstract mixin class $UiSystemMessage_ReceivedConnectionConfirmationCopyWith<$Res> implements $UiSystemMessageCopyWith<$Res> {
...
/// @nodoc
class _$UiSystemMessage_ReceivedConnectionConfirmationCopyWithImpl<$Res>
    implements $UiSystemMessage_ReceivedConnectionConfirmationCopyWith<$Res> {
  _$UiSystemMessage_ReceivedConnectionConfirmationCopyWithImpl(this._self, this._then);

  final UiSystemMessage_ReceivedConnectionConfirmation _self;
  final $Res Function(UiSystemMessage_ReceivedConnectionConfirmation) _then;
...
class UiSystemMessage_NewHandleConnectionChat extends UiSystemMessage {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UiSystemMessage_NewHandleConnectionChatCopyWith<UiSystemMessage_NewHandleConnectionChat> get copyWith => _$UiSystemMessage_NewHandleConnectionChatCopyWithImpl<UiSystemMessage_NewHandleConnectionChat>(this, _$identity);
...
/// @nodoc
abstract mixin class $UiSystemMessage_NewHandleConnectionChatCopyWith<$Res> implements $UiSystemMessageCopyWith<$Res> {
...
/// @nodoc
class _$UiSystemMessage_NewHandleConnectionChatCopyWithImpl<$Res>
    implements $UiSystemMessage_NewHandleConnectionChatCopyWith<$Res> {
  _$UiSystemMessage_NewHandleConnectionChatCopyWithImpl(this._self, this._then);

  final UiSystemMessage_NewHandleConnectionChat _self;
  final $Res Function(UiSystemMessage_NewHandleConnectionChat) _then;
