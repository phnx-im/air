...
// These functions are ignored because they are not marked as `pub`: `apply_messages`, `clear_first_unread_index`, `clear_first_unread_index`, `emit_state_and_transition`, `handle_jump_to_bottom`, `handle_jump_to_message`, `handle_load_newer`, `handle_load_older`, `initial_load`, `issue_command`, `load_bottom`, `load_is_connection_chat`, `new`, `newest_first`, `newest_index`, `process_store_notification`, `rebuild_message_ids_index`, `remove_message_in_place`, `remove_message`, `run_loop`, `spawn`, `try_process_store_notification`, `update_message_in_place`, `update_message_in_place`, `with_page_capacity`
