...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1586849808;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool?>
  crateApiAttachmentsRepositoryAttachmentsRepositoryIsAttachmentAnimated({
    required AttachmentsRepository that,
    required AttachmentId attachmentId,
  ...
  Future<GroupDebugInfo>
  crateApiChatDetailsCubitChatDetailsCubitBaseChatDebugInfo({
    required ChatDetailsCubitBase that,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseClose({
    required ChatDetailsCubitBase that,
  });
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDeleteReaction({
    required ChatDetailsCubitBase that,
    required MessageId messageId,
    required String emoji,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateApqKey({
    required ChatDetailsCubitBase that,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateKey({
    required ChatDetailsCubitBase that,
  });
  ...
  bool crateApiChatDetailsCubitChatDetailsCubitBaseIsClosed({
    required ChatDetailsCubitBase that,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseMarkAsRead({
    required ChatDetailsCubitBase that,
    required MessageId untilMessageId,
    required DateTime untilTimestamp,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseMuteChat({
    required ChatDetailsCubitBase that,
    UiChatMuted? mutedUntil,
  });

  ChatDetailsCubitBase crateApiChatDetailsCubitChatDetailsCubitBaseNew({
    required UserCubitBase userCubit,
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseReplyToMessage({
    required ChatDetailsCubitBase that,
    required MessageId messageId,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseRequestResync({
    required ChatDetailsCubitBase that,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseResetDraft({
    required ChatDetailsCubitBase that,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseResetDraftReply({
    required ChatDetailsCubitBase that,
  });
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseSendReaction({
    required ChatDetailsCubitBase that,
    required MessageId messageId,
    required String emoji,
  });

  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseSetChatPicture({
    required ChatDetailsCubitBase that,
    Uint8List? bytes,
  });
  ...
  Future<void>
  crateApiInvitationCodesCubitInvitationCodesCubitBaseClearCopiedCodes({
    required InvitationCodesCubitBase that,
  });

  Future<void> crateApiInvitationCodesCubitInvitationCodesCubitBaseClose({
    required InvitationCodesCubitBase that,
  });

  bool crateApiInvitationCodesCubitInvitationCodesCubitBaseIsClosed({
    required InvitationCodesCubitBase that,
  });
  ...
  crateApiInvitationCodesCubitInvitationCodesCubitBaseState({
    required InvitationCodesCubitBase that,
  });

  Stream<InvitationCodesState>
  crateApiInvitationCodesCubitInvitationCodesCubitBaseStream({
    required InvitationCodesCubitBase that,
  });

  Future<void> crateApiLinkedDevicesCubitLinkedDevicesCubitBaseClose({
    required LinkedDevicesCubitBase that,
  });

  bool crateApiLinkedDevicesCubitLinkedDevicesCubitBaseIsClosed({
    required LinkedDevicesCubitBase that,
  });

  LinkedDevicesCubitBase crateApiLinkedDevicesCubitLinkedDevicesCubitBaseNew({
    required UserCubitBase userCubit,
  });
  ...
  LinkedDevicesState crateApiLinkedDevicesCubitLinkedDevicesCubitBaseState({
    required LinkedDevicesCubitBase that,
  });

  Stream<LinkedDevicesState>
  crateApiLinkedDevicesCubitLinkedDevicesCubitBaseStream({
    required LinkedDevicesCubitBase that,
  });
  ...
  Future<void> crateApiMemberDetailsCubitMemberDetailsCubitBaseClose({
    required MemberDetailsCubitBase that,
  });

  bool crateApiMemberDetailsCubitMemberDetailsCubitBaseIsClosed({
    required MemberDetailsCubitBase that,
  });

  MemberDetailsCubitBase crateApiMemberDetailsCubitMemberDetailsCubitBaseNew({
    required UserCubitBase userCubit,
    required ChatId chatId,
  });

  MemberDetailsState crateApiMemberDetailsCubitMemberDetailsCubitBaseState({
    required MemberDetailsCubitBase that,
  });

  Stream<MemberDetailsState>
  crateApiMemberDetailsCubitMemberDetailsCubitBaseStream({
    required MemberDetailsCubitBase that,
  });
  ...
  Future<void> crateApiMessageListCubitMessageListCubitBaseJumpToBottom({
    required MessageListCubitBase that,
  });

  Future<void> crateApiMessageListCubitMessageListCubitBaseJumpToMessage({
    required MessageListCubitBase that,
    required MessageId messageId,
  });

  Future<void> crateApiMessageListCubitMessageListCubitBaseLoadNewer({
    required MessageListCubitBase that,
  });

  Future<void> crateApiMessageListCubitMessageListCubitBaseLoadOlder({
    required MessageListCubitBase that,
  });
  ...
  Stream<MessageListTransition>
  crateApiMessageListCubitMessageListCubitBaseTransitions({
    required MessageListCubitBase that,
  });
  ...
  crateApiMultiDeviceMultiDeviceLinkConfirmationNew();

  MultiDeviceProvisionedUser crateApiMultiDeviceMultiDeviceProvisionedUserNew();

  User? crateApiMultiDeviceMultiDeviceProvisionedUserTake({
  ...
  Future<void> crateApiUserCubitUserCubitBaseBlockContact({
    required UserCubitBase that,
    required UiUserId userId,
  });

  Future<UsernameHash?> crateApiUserCubitUserCubitBaseCheckUsernameExists({
    required UserCubitBase that,
    required UiUsername username,
  });
  ...
  Future<UiContact?> crateApiUserCubitUserCubitBaseContact({
    required UserCubitBase that,
    required UiUserId userId,
  });
  ...
  Future<void> crateApiUserCubitUserCubitBaseDevEraseChat({
    required UserCubitBase that,
    required ChatId chatId,
  });
  ...
  Future<void> crateApiUserCubitUserCubitBaseLeaveChat({
    required UserCubitBase that,
    required ChatId chatId,
  });
  ...
  Future<void> crateApiUserCubitUserCubitBaseRemoveUserFromChat({
    required UserCubitBase that,
    required ChatId chatId,
    required UiUserId userId,
  });

  Future<void> crateApiUserCubitUserCubitBaseRemoveUsername({
    required UserCubitBase that,
    required UiUsername username,
  });
  ...
  Future<void> crateApiUserCubitUserCubitBaseUnblockContact({
    required UserCubitBase that,
    required UiUserId userId,
  });

  Future<String> crateApiUserCubitUserCubitBaseUploadLogs({
    required UserCubitBase that,
  ...
  Future<void>
  crateApiUserSettingsCubitUserSettingsCubitBaseSetDefaultEmojiSkinTone({
    required UserSettingsCubitBase that,
    required int value,
  });
  ...
  Future<void> crateApiUserSettingsCubitUserSettingsCubitBaseSetReadReceipts({
    required UserSettingsCubitBase that,
    required bool value,
  });
  ...
  Future<void> crateApiUserUserTriggerTimedTask({
    required User that,
  ...
  String crateApiUtilsAppVersion();
  ...
  Future<NewAdmissionSession> crateApiRegistrationCreateAdmissionSession({
    required String domain,
    required PlatformPushToken pushToken,
  });

  Stream<DbMigrationState> crateApiMigrationCreateDbMigrationStream();
  ...
  Future<RegistrationInfo> crateApiRegistrationGetRegistrationInfo({
    required String domain,
  });
  ...
  Stream<MultiDeviceLinkEvent> crateApiMultiDeviceMultiDeviceLinkClient({
    required UserCubitBase userCubit,
    required String sessionId,
    required MultiDeviceLinkConfirmation confirmation,
  });

  Stream<MultiDeviceProvisionEvent>
  crateApiMultiDeviceMultiDeviceProvisionClient({
    required String domain,
    required String dbPath,
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_ChatDetailsCubitBase;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_ChatDetailsCubitBase;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_InvitationCodesCubitBase;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_InvitationCodesCubitBase;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_InvitationCodesCubitBasePtr;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_LinkedDevicesCubitBase;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_LinkedDevicesCubitBase;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_LinkedDevicesCubitBasePtr;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MemberDetailsCubitBase;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MemberDetailsCubitBase;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MultiDeviceLinkConfirmation;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MultiDeviceLinkConfirmation;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_MultiDeviceLinkConfirmationPtr;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MultiDeviceProvisionedUser;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MultiDeviceProvisionedUser;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_UsernameHash;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_UsernameHash;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  crateApiAttachmentsRepositoryAttachmentsRepositoryIsAttachmentAnimated({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiAttachmentsRepositoryAttachmentsRepositoryIsAttachmentAnimatedConstMeta,
        argValues: [that, attachmentId, retryDownloadIfFailed],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiAttachmentsRepositoryAttachmentsRepositoryIsAttachmentAnimatedConstMeta =>
      const TaskConstMeta(
        debugName: "AttachmentsRepository_is_attachment_animated",
        argNames: ["that", "attachmentId", "retryDownloadIfFailed"],
      );
  ...
  crateApiAttachmentsRepositoryAttachmentsRepositoryLoadThumbnail({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiAttachmentsRepositoryAttachmentsRepositoryLoadThumbnailConstMeta,
        argValues: [that, attachmentId, retryDownloadIfFailed],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiAttachmentsRepositoryAttachmentsRepositoryLoadThumbnailConstMeta =>
      const TaskConstMeta(
        debugName: "AttachmentsRepository_load_thumbnail",
        argNames: ["that", "attachmentId", "retryDownloadIfFailed"],
      );
  ...
  crateApiChatDetailsCubitChatDetailsCubitBaseAcceptContactRequest({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseAcceptContactRequestConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseAcceptContactRequestConstMeta =>
      const TaskConstMeta(
  ...
  crateApiChatDetailsCubitChatDetailsCubitBaseChatDebugInfo({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseChatDebugInfoConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseChatDebugInfoConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseCloseConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDeleteReaction({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseDeleteReactionConstMeta,
        argValues: [that, messageId, emoji],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseDeleteReactionConstMeta =>
      const TaskConstMeta(
        debugName: "ChatDetailsCubitBase_delete_reaction",
        argNames: ["that", "messageId", "emoji"],
      );
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateApqKey({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateApqKeyConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateApqKeyConstMeta =>
      const TaskConstMeta(
        debugName: "ChatDetailsCubitBase_dev_update_apq_key",
        argNames: ["that"],
      );
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateKey({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateKeyConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateKeyConstMeta =>
      const TaskConstMeta(
        debugName: "ChatDetailsCubitBase_dev_update_key",
        argNames: ["that"],
      );
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseEditMessage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseEditMessageConstMeta,
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseEditMessageConstMeta =>
      const TaskConstMeta(
  ...
  bool crateApiChatDetailsCubitChatDetailsCubitBaseIsClosed({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseIsClosedConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseIsClosedConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseMarkAsRead({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseMarkAsReadConstMeta,
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseMarkAsReadConstMeta =>
      const TaskConstMeta(
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_box_autoadd_ui_chat_muted(mutedUntil, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 19,
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseMuteChatConstMeta,
        argValues: [that, mutedUntil],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseMuteChatConstMeta =>
      const TaskConstMeta(
        debugName: "ChatDetailsCubitBase_mute_chat",
        argNames: ["that", "mutedUntil"],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_opt_box_autoadd_ui_chat_details(chat, serializer);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAttachmentsRepository(
  ...
  TaskConstMeta get kCrateApiChatDetailsCubitChatDetailsCubitBaseNewConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseReplyToMessage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseReplyToMessageConstMeta,
        argValues: [that, messageId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseReplyToMessageConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseRequestResync({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseRequestResyncConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseRequestResyncConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseResetDraft({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseResetDraftConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseResetDraftConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseResetDraftReplyConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseSendMessage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseSendMessageConstMeta,
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseSendMessageConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseSendReaction({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseSendReactionConstMeta,
        argValues: [that, messageId, emoji],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseSendReactionConstMeta =>
      const TaskConstMeta(
        debugName: "ChatDetailsCubitBase_send_reaction",
        argNames: ["that", "messageId", "emoji"],
      );
  ...
  Future<void> crateApiChatDetailsCubitChatDetailsCubitBaseSetChatPicture({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseSetChatPictureConstMeta,
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseSetChatPictureConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseStateConstMeta =>
      const TaskConstMeta(
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta:
              kCrateApiChatDetailsCubitChatDetailsCubitBaseStreamConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseStreamConstMeta =>
      const TaskConstMeta(
  ...
  crateApiChatDetailsCubitChatDetailsCubitBaseUploadAttachment({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiChatDetailsCubitChatDetailsCubitBaseUploadAttachmentConstMeta,
        argValues: [that, path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiChatDetailsCubitChatDetailsCubitBaseUploadAttachmentConstMeta =>
      const TaskConstMeta(
      ...
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_chats_delta_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
              serializer,
              funcId: 39,
  ...
  crateApiInvitationCodesCubitInvitationCodesCubitBaseClearCopiedCodes({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesCubitBaseClearCopiedCodesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseClearCopiedCodesConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiInvitationCodesCubitInvitationCodesCubitBaseClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesCubitBaseCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseCloseConstMeta =>
      const TaskConstMeta(
  ...
  bool crateApiInvitationCodesCubitInvitationCodesCubitBaseIsClosed({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesCubitBaseIsClosedConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseIsClosedConstMeta =>
      const TaskConstMeta(
  ...
  crateApiInvitationCodesCubitInvitationCodesCubitBaseNew({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesCubitBaseNewConstMeta,
        argValues: [userCubit],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseNewConstMeta =>
      const TaskConstMeta(
  ...
  crateApiInvitationCodesCubitInvitationCodesCubitBaseState({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesCubitBaseStateConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseStateConstMeta =>
      const TaskConstMeta(
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta:
              kCrateApiInvitationCodesCubitInvitationCodesCubitBaseStreamConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesCubitBaseStreamConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiLinkedDevicesCubitLinkedDevicesCubitBaseClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseCloseConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_close",
        argNames: ["that"],
      );
  ...
  bool crateApiLinkedDevicesCubitLinkedDevicesCubitBaseIsClosed({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseIsClosedConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseIsClosedConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_is_closed",
        argNames: ["that"],
      );
  ...
  LinkedDevicesCubitBase crateApiLinkedDevicesCubitLinkedDevicesCubitBaseNew({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseNewConstMeta,
        argValues: [userCubit],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseNewConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_new",
        argNames: ["userCubit"],
      );
  ...
  Future<void> crateApiLinkedDevicesCubitLinkedDevicesCubitBaseRenameDevice({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseRenameDeviceConstMeta,
        argValues: [that, clientId, name],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseRenameDeviceConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_rename_device",
        argNames: ["that", "clientId", "name"],
      );
  ...
  LinkedDevicesState crateApiLinkedDevicesCubitLinkedDevicesCubitBaseState({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_linked_devices_state,
          decodeErrorData: null,
        ),
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseStateConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseStateConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_state",
        argNames: ["that"],
      );
  ...
  crateApiLinkedDevicesCubitLinkedDevicesCubitBaseStream({
    ...
    final sink = RustStreamSink<LinkedDevicesState>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_linked_devices_state_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
              serializer,
              funcId: 54,
          ...
          constMeta:
              kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseStreamConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseStreamConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_stream",
        argNames: ["that", "sink"],
      );
  ...
  Future<void> crateApiLinkedDevicesCubitLinkedDevicesCubitBaseUnlinkDevice({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseUnlinkDeviceConstMeta,
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesCubitBaseUnlinkDeviceConstMeta =>
      const TaskConstMeta(
        debugName: "LinkedDevicesCubitBase_unlink_device",
  ...
  Future<void> crateApiMemberDetailsCubitMemberDetailsCubitBaseClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMemberDetailsCubitMemberDetailsCubitBaseCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsCubitBaseCloseConstMeta =>
      const TaskConstMeta(
  ...
  bool crateApiMemberDetailsCubitMemberDetailsCubitBaseIsClosed({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiMemberDetailsCubitMemberDetailsCubitBaseIsClosedConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsCubitBaseIsClosedConstMeta =>
      const TaskConstMeta(
  ...
  MemberDetailsCubitBase crateApiMemberDetailsCubitMemberDetailsCubitBaseNew({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiMemberDetailsCubitMemberDetailsCubitBaseNewConstMeta,
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsCubitBaseNewConstMeta =>
      const TaskConstMeta(
  ...
  MemberDetailsState crateApiMemberDetailsCubitMemberDetailsCubitBaseState({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiMemberDetailsCubitMemberDetailsCubitBaseStateConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsCubitBaseStateConstMeta =>
      const TaskConstMeta(
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta:
              kCrateApiMemberDetailsCubitMemberDetailsCubitBaseStreamConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsCubitBaseStreamConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiMessageListCubitMessageListCubitBaseJumpToBottom({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMessageListCubitMessageListCubitBaseJumpToBottomConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMessageListCubitMessageListCubitBaseJumpToBottomConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiMessageListCubitMessageListCubitBaseJumpToMessage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMessageListCubitMessageListCubitBaseJumpToMessageConstMeta,
        argValues: [that, messageId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMessageListCubitMessageListCubitBaseJumpToMessageConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiMessageListCubitMessageListCubitBaseLoadNewer({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMessageListCubitMessageListCubitBaseLoadNewerConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMessageListCubitMessageListCubitBaseLoadNewerConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiMessageListCubitMessageListCubitBaseLoadOlder({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMessageListCubitMessageListCubitBaseLoadOlderConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMessageListCubitMessageListCubitBaseLoadOlderConstMeta =>
      const TaskConstMeta(
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta:
              kCrateApiMessageListCubitMessageListCubitBaseTransitionsConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiMessageListCubitMessageListCubitBaseTransitionsConstMeta =>
      const TaskConstMeta(
  ...
  crateApiMultiDeviceMultiDeviceLinkConfirmationNew() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMultiDeviceMultiDeviceLinkConfirmationNewConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMultiDeviceMultiDeviceLinkConfirmationNewConstMeta =>
      const TaskConstMeta(
        debugName: "MultiDeviceLinkConfirmation_new",
        argNames: [],
      );

  @override
  MultiDeviceProvisionedUser
  crateApiMultiDeviceMultiDeviceProvisionedUserNew() {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiMultiDeviceMultiDeviceProvisionedUserNewConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMultiDeviceMultiDeviceProvisionedUserNewConstMeta =>
      const TaskConstMeta(
        debugName: "MultiDeviceProvisionedUser_new",
        argNames: [],
      );
  ...
  User? crateApiMultiDeviceMultiDeviceProvisionedUserTake({
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
            that,
            serializer,
          );
        ...
        constMeta: kCrateApiMultiDeviceMultiDeviceProvisionedUserTakeConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMultiDeviceMultiDeviceProvisionedUserTakeConstMeta =>
      const TaskConstMeta(
        debugName: "MultiDeviceProvisionedUser_take",
        argNames: ["that"],
      );
  ...
  TaskConstMeta get kCrateApiMemberDetailsCubitUiRoomStateCanKickConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseAddUsernameConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseBlockContactConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta
  get kCrateApiUserCubitUserCubitBaseCheckUsernameExistsConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseContactConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseDeleteChatConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiUserCubitUserCubitBaseDevEraseChat({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiUserCubitUserCubitBaseDevEraseChatConstMeta,
        argValues: [that, chatId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseDevEraseChatConstMeta =>
      const TaskConstMeta(
        debugName: "UserCubitBase_dev_erase_chat",
        argNames: ["that", "chatId"],
      );
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseLeaveChatConstMeta =>
      const TaskConstMeta(
  ...
  String? crateApiUserCubitUserCubitBaseParseMultiDeviceLinkingUrl({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiUserCubitUserCubitBaseParseMultiDeviceLinkingUrlConstMeta,
        argValues: [that, url],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiUserCubitUserCubitBaseParseMultiDeviceLinkingUrlConstMeta =>
      const TaskConstMeta(
        debugName: "UserCubitBase_parse_multi_device_linking_url",
        argNames: ["that", "url"],
      );
  ...
  TaskConstMeta
  get kCrateApiUserCubitUserCubitBaseRemoveUserFromChatConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseRemoveUsernameConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseSafetyCodesConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserCubitUserCubitBaseUnblockContactConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiUserCubitUserCubitBaseUploadLogs({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiUserCubitUserCubitBaseUploadLogsConstMeta,
        argValues: [that, cacheDir],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiUserCubitUserCubitBaseUploadLogsConstMeta =>
      const TaskConstMeta(
        debugName: "UserCubitBase_upload_logs",
        argNames: ["that", "cacheDir"],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_box_autoadd_user_settings(initial, serializer);
          return pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 125,
  ...
  crateApiUserSettingsCubitUserSettingsCubitBaseSetDefaultEmojiSkinTone({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiUserSettingsCubitUserSettingsCubitBaseSetDefaultEmojiSkinToneConstMeta,
  ...
  TaskConstMeta
  get kCrateApiUserSettingsCubitUserSettingsCubitBaseSetDefaultEmojiSkinToneConstMeta =>
      const TaskConstMeta(
        debugName: "UserSettingsCubitBase_set_default_emoji_skin_tone",
        argNames: ["that", "value"],
      );
  ...
  Future<void> crateApiUserSettingsCubitUserSettingsCubitBaseSetLocale({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiUserSettingsCubitUserSettingsCubitBaseSetLocaleConstMeta,
        argValues: [that, value],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiUserSettingsCubitUserSettingsCubitBaseSetLocaleConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiUserSettingsCubitUserSettingsCubitBaseSetReadReceipts({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiUserSettingsCubitUserSettingsCubitBaseSetReadReceiptsConstMeta,
        argValues: [that, value],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiUserSettingsCubitUserSettingsCubitBaseSetReadReceiptsConstMeta =>
      const TaskConstMeta(
  ...
  UuidValue crateApiUserUserClientRecordId({required User that}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiUserUserClientRecordIdConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiUserUserClientRecordIdConstMeta =>
      const TaskConstMeta(
        debugName: "User_client_record_id",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_list_prim_u_8_strict(profilePicture, serializer);
          sse_encode_opt_box_autoadd_registration_challenge(
            challenge,
            serializer,
          );
          pdeCallFfi(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUser,
          decodeErrorData: sse_decode_create_user_error,
        ),
  ...
  TaskConstMeta get kCrateApiUserUserPrepareForBackgroundConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUserUserSignalPendingStoreNotificationsConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiUserUserTriggerTimedTask({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiUserUserTriggerTimedTaskConstMeta,
        argValues: [that, id],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiUserUserTriggerTimedTaskConstMeta =>
      const TaskConstMeta(
        debugName: "User_trigger_timed_task",
        argNames: ["that", "id"],
      );
  ...
  TaskConstMeta get kCrateApiUserUserUserDebugInfoConstMeta =>
      const TaskConstMeta(
  ...
  String crateApiUtilsAppVersion() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiUtilsAppVersionConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiUtilsAppVersionConstMeta =>
  ...
  TaskConstMeta get kCrateApiChatDetailsCubitChatDetailsStateDefaultConstMeta =>
      const TaskConstMeta(
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(domain, serializer);
          sse_encode_box_autoadd_platform_push_token(pushToken, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 163,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_new_admission_session,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiRegistrationCreateAdmissionSessionConstMeta,
        argValues: [domain, pushToken],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiRegistrationCreateAdmissionSessionConstMeta =>
      const TaskConstMeta(
        debugName: "create_admission_session",
        argNames: ["domain", "pushToken"],
      );

  @override
  Stream<DbMigrationState> crateApiMigrationCreateDbMigrationStream() {
    final sink = RustStreamSink<DbMigrationState>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            final serializer = SseSerializer(generalizedFrbRustBinding);
            sse_encode_StreamSink_db_migration_state_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
              serializer,
              funcId: 164,
          ...
          constMeta: kCrateApiMigrationCreateDbMigrationStreamConstMeta,
          argValues: [sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCrateApiMigrationCreateDbMigrationStreamConstMeta =>
      const TaskConstMeta(
        debugName: "create_db_migration_stream",
        argNames: ["sink"],
      );
  ...
  Future<RegistrationInfo> crateApiRegistrationGetRegistrationInfo({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_registration_info,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiRegistrationGetRegistrationInfoConstMeta,
        argValues: [domain],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRegistrationGetRegistrationInfoConstMeta =>
      const TaskConstMeta(
        debugName: "get_registration_info",
        argNames: ["domain"],
      );
  ...
  crateApiInvitationCodesCubitInvitationCodesStateDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiInvitationCodesCubitInvitationCodesStateDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiInvitationCodesCubitInvitationCodesStateDefaultConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiUtilsIsImageFileConstMeta =>
      const TaskConstMeta(debugName: "is_image_file", argNames: ["path"]);
  ...
  crateApiLinkedDevicesCubitLinkedDevicesStateDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiLinkedDevicesCubitLinkedDevicesStateDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiLinkedDevicesCubitLinkedDevicesStateDefaultConstMeta =>
      const TaskConstMeta(
        debugName: "linked_devices_state_default",
        argNames: [],
      );
  ...
  Future<UserSettings> crateApiUserSettingsCubitLoadUserSettings({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiUserSettingsCubitLoadUserSettingsConstMeta,
        argValues: [user],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiUserSettingsCubitLoadUserSettingsConstMeta =>
      const TaskConstMeta(debugName: "load_user_settings", argNames: ["user"]);
  ...
  crateApiMemberDetailsCubitMemberDetailsStateDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiMemberDetailsCubitMemberDetailsStateDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMemberDetailsCubitMemberDetailsStateDefaultConstMeta =>
      const TaskConstMeta(
  ...
  Stream<MultiDeviceLinkEvent> crateApiMultiDeviceMultiDeviceLinkClient({
    ...
    final sink = RustStreamSink<MultiDeviceLinkEvent>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_multi_device_link_event_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
              serializer,
              funcId: 180,
          ...
          constMeta: kCrateApiMultiDeviceMultiDeviceLinkClientConstMeta,
          argValues: [userCubit, sessionId, confirmation, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiMultiDeviceMultiDeviceLinkClientConstMeta =>
      const TaskConstMeta(
        debugName: "multi_device_link_client",
        argNames: ["userCubit", "sessionId", "confirmation", "sink"],
      );
  ...
  crateApiMultiDeviceMultiDeviceProvisionClient({
    ...
    final sink = RustStreamSink<MultiDeviceProvisionEvent>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_multi_device_provision_event_Sse(
              sink,
              serializer,
            );
            pdeCallFfi(
          ...
          constMeta: kCrateApiMultiDeviceMultiDeviceProvisionClientConstMeta,
          argValues: [domain, dbPath, provisionedUser, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiMultiDeviceMultiDeviceProvisionClientConstMeta =>
      const TaskConstMeta(
        debugName: "multi_device_provision_client",
        argNames: ["domain", "dbPath", "provisionedUser", "sink"],
      );
  ...
  TaskConstMeta get kCrateApiUtilsReadClipboardFilePathsConstMeta =>
      const TaskConstMeta(debugName: "read_clipboard_file_paths", argNames: []);
  ...
  UsernameValidationError? crateApiTypesUiUsernameValidationError({
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_ui_username(that, serializer);
          return pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 190,
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_opt_box_autoadd_username_validation_error,
          decodeErrorData: null,
        ),
  ...
  TaskConstMeta get kCrateApiTypesUiUsernameValidationErrorConstMeta =>
      const TaskConstMeta(
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MemberDetailsCubitBase => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MemberDetailsCubitBase => wire
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MultiDeviceLinkConfirmation => wire
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MultiDeviceLinkConfirmation => wire
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_MultiDeviceProvisionedUser => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_MultiDeviceProvisionedUser => wire
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_UiRoomState => wire
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerInvitationCodesCubitBase(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return InvitationCodesCubitBaseImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLinkedDevicesCubitBase(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return LinkedDevicesCubitBaseImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return MemberDetailsCubitBaseImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceLinkConfirmation(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return MultiDeviceLinkConfirmationImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  @protected
  MultiDeviceProvisionedUser
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  @protected
  MultiDeviceProvisionedUser
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalDcoDecode(
  ...
  @protected
  MultiDeviceProvisionedUser
  dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalDcoDecode(
  ...
  @protected
  Set<ChatId> dco_decode_Set_chat_id_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Set.from(dco_decode_list_chat_id(raw));
  }
  ...
  @protected
  RustStreamSink<ChatsDelta> dco_decode_StreamSink_chats_delta_Sse(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError();
  ...
  dco_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
      raw,
    );
  }
  ...
  AdmissionSession dco_decode_box_autoadd_admission_session(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_admission_session(raw);
  }
  ...
  dco_decode_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_record_ui_mimi_id_ui_in_reply_to_message(raw);
  }
  ...
  RegistrationChallenge dco_decode_box_autoadd_registration_challenge(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_registration_challenge(raw);
  }
  ...
  UiChatMuted dco_decode_box_autoadd_ui_chat_muted(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_ui_chat_muted(raw);
  }
  ...
  @protected
  UiInReplyToMessage dco_decode_box_autoadd_ui_in_reply_to_message(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
  ...
  ChallengeKind dco_decode_challenge_kind(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ChallengeKind.values[raw as int];
  }
  ...
  ChatsDelta dco_decode_chats_delta(dynamic raw) {
    ...
    return ChatsDelta(
      upserted: dco_decode_list_ui_chat_details(arr[0]),
      removed: dco_decode_Set_chat_id_None(arr[1]),
  ...
  CreateUserError dco_decode_create_user_error(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return CreateUserError_ChallengeRequired(
          accepted: dco_decode_list_challenge_kind(raw[1]),
        );
      case 1:
        return CreateUserError_ChallengeRejected();
      case 2:
        return CreateUserError_Other(message: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  DbMigrationState dco_decode_db_migration_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DbMigrationState.values[raw as int];
  }
  ...
  Error dco_decode_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Error.values[raw as int];
  }
  ...
  LinkedDevicesState dco_decode_linked_devices_state(dynamic raw) {
    ...
    return LinkedDevicesState(
      devices: dco_decode_list_ui_linked_device(arr[0]),
    );
  }
  ...
  List<ChallengeKind> dco_decode_list_challenge_kind(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_challenge_kind).toList();
  }
  ...
  List<(ChatId, List<UiUserId>)> dco_decode_list_record_chat_id_list_ui_user_id(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_record_chat_id_list_ui_user_id)
        .toList();
  }
  ...
  List<(int, DebugCapabilities)> dco_decode_list_record_u_32_debug_capabilities(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_record_u_32_debug_capabilities)
        .toList();
  }
  ...
  List<TimedTaskDebugInfo> dco_decode_list_timed_task_debug_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_timed_task_debug_info)
        .toList();
  }
  ...
  List<UiChatDetails> dco_decode_list_ui_chat_details(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_ui_chat_details).toList();
  }
  ...
  List<UiLinkedDevice> dco_decode_list_ui_linked_device(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_ui_linked_device).toList();
  }
  ...
  MessageListChange dco_decode_message_list_change(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return MessageListChange_Reload(
          messages: dco_decode_list_ui_chat_message(raw[1]),
        );
      case 1:
        return MessageListChange_Splice(
          index: dco_decode_usize(raw[1]),
          messages: dco_decode_list_ui_chat_message(raw[2]),
          deleteCount: dco_decode_usize(raw[3]),
        );
      case 2:
        return MessageListChange_Patch(
          index: dco_decode_usize(raw[1]),
          message: dco_decode_box_autoadd_ui_chat_message(raw[2]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  MessageListCommand dco_decode_message_list_command(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return MessageListCommand_ScrollToId(
          messageId: dco_decode_box_autoadd_message_id(raw[1]),
        );
      case 1:
        return MessageListCommand_ScrollToBottom();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  MessageListTransition dco_decode_message_list_transition(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return MessageListTransition(
      revision: dco_decode_CastedPrimitive_usize(arr[0]),
  ...
  MultiDeviceLinkEvent dco_decode_multi_device_link_event(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return MultiDeviceLinkEvent_AwaitingConfirmation();
      case 1:
        return MultiDeviceLinkEvent_Linked();
      case 2:
  ...
  MultiDeviceProvisionEvent dco_decode_multi_device_provision_event(
    ...
    switch (raw[0]) {
      case 0:
        return MultiDeviceProvisionEvent_Code(
          qrcodeSvg: dco_decode_opt_String(raw[1]),
          code: dco_decode_String(raw[2]),
        );
      case 1:
        return MultiDeviceProvisionEvent_Linking();
      case 2:
        return MultiDeviceProvisionEvent_Linked();
      case 3:
  ...
  dco_decode_opt_box_autoadd_add_username_contact_error(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_add_username_contact_error(raw);
  }
  ...
  MessageListCommand? dco_decode_opt_box_autoadd_message_list_command(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_message_list_command(raw);
  }
  ...
  dco_decode_opt_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(raw);
  }
  ...
  RegistrationChallenge? dco_decode_opt_box_autoadd_registration_challenge(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_registration_challenge(raw);
  }
  ...
  dco_decode_opt_box_autoadd_request_invitation_code_error(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_request_invitation_code_error(raw);
  }
  ...
  UiChatMuted? dco_decode_opt_box_autoadd_ui_chat_muted(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_ui_chat_muted(raw);
  }
  ...
  UploadAttachmentError? dco_decode_opt_box_autoadd_upload_attachment_error(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_upload_attachment_error(raw);
  }
  ...
  @protected
  List<ChatId>? dco_decode_opt_list_chat_id(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_list_chat_id(raw);
  }
  ...
  (ChatId, List<UiUserId>) dco_decode_record_chat_id_list_ui_user_id(
    ...
    return (dco_decode_chat_id(arr[0]), dco_decode_list_ui_user_id(arr[1]));
  }
  ...
  dco_decode_record_ui_mimi_id_ui_in_reply_to_message(dynamic raw) {
    ...
    return (
      dco_decode_ui_mimi_id(arr[0]),
      dco_decode_ui_in_reply_to_message(arr[1]),
    );
  }
  ...
  RegistrationChallenge dco_decode_registration_challenge(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return RegistrationChallenge_InvitationCode(dco_decode_String(raw[1]));
      case 1:
        return RegistrationChallenge_AdmissionSession(
          dco_decode_box_autoadd_admission_session(raw[1]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  RegistrationInfo dco_decode_registration_info(dynamic raw) {
    ...
    return RegistrationInfo(
      challengeRequired: dco_decode_bool(arr[0]),
      acceptedChallenges: dco_decode_list_challenge_kind(arr[1]),
    );
  }
  ...
  @protected
  RequiredDebugCapabilities dco_decode_required_debug_capabilities(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return RequiredDebugCapabilities(
  ...
  TimedTaskDebugInfo dco_decode_timed_task_debug_info(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return TimedTaskDebugInfo(
      id: dco_decode_list_prim_u_8_strict(arr[0]),
      name: dco_decode_String(arr[1]),
      scheduledAt: dco_decode_Chrono_Utc(arr[2]),
    );
  }
  ...
  UiAttachmentStatus dco_decode_ui_attachment_status(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return UiAttachmentStatus_Pending();
      case 1:
        return UiAttachmentStatus_Progress(dco_decode_usize(raw[1]));
      case 2:
  ...
  UiChatMuted dco_decode_ui_chat_muted(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return UiChatMuted_Until(dco_decode_Chrono_Utc(raw[1]));
      case 1:
        return UiChatMuted_Forever();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  UiChatType dco_decode_ui_chat_type(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return UiChatType_HandleConnection(
          dco_decode_box_autoadd_ui_username(raw[1]),
        );
      case 1:
        return UiChatType_Connection(
          dco_decode_box_autoadd_ui_user_profile(raw[1]),
        );
      case 2:
        return UiChatType_TargetedMessageConnection(
          dco_decode_box_autoadd_ui_user_profile(raw[1]),
        );
      case 3:
  ...
  UiClientRecord dco_decode_ui_client_record(dynamic raw) {
    ...
    return UiClientRecord(
      clientRecordId: dco_decode_Uuid(arr[0]),
      userId: dco_decode_ui_user_id(arr[1]),
      createdAt: dco_decode_Chrono_Utc(arr[2]),
      userProfile: dco_decode_ui_user_profile(arr[3]),
  ...
  UiInReplyToMessage dco_decode_ui_in_reply_to_message(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return UiInReplyToMessage_NotFound();
      case 1:
        return UiInReplyToMessage_Resolved(
          messageId: dco_decode_box_autoadd_message_id(raw[1]),
          sender: dco_decode_box_autoadd_ui_user_id(raw[2]),
          mimiContent: dco_decode_box_autoadd_ui_mimi_content(raw[3]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  UiReaction dco_decode_ui_reaction(dynamic raw) {
    ...
    return UiReaction(
      ...
      users: dco_decode_list_ui_user_id(arr[1]),
    );
  }
    ...
    switch (raw[0]) {
      ...
      case 6:
        return UiSystemMessage_AcceptedConnectionRequest(
          sender: dco_decode_box_autoadd_ui_user_id(raw[1]),
          username: dco_decode_opt_box_autoadd_ui_username(raw[2]),
        );
      case 7:
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerChatDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return ChatDetailsCubitBaseImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerInvitationCodesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return InvitationCodesCubitBaseImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLinkedDevicesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return LinkedDevicesCubitBaseImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return MemberDetailsCubitBaseImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceLinkConfirmation(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return MultiDeviceLinkConfirmationImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return UsernameHashImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  @protected
  MultiDeviceProvisionedUser
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalSseDecode(
  ...
  Map<ChatId, List<UiUserId>> sse_decode_Map_chat_id_list_ui_user_id_None(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_list_record_chat_id_list_ui_user_id(deserializer);
  ...
  @protected
  MultiDeviceProvisionedUser
  sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return MultiDeviceProvisionedUserImpl.frbInternalSseDecode(
  ...
  @protected
  Set<ChatId> sse_decode_Set_chat_id_None(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_list_chat_id(deserializer);
  ...
  @protected
  RustStreamSink<ChatsDelta> sse_decode_StreamSink_chats_delta_Sse(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    throw UnimplementedError('Unreachable ()');
  ...
  AdmissionSession sse_decode_admission_session(SseDeserializer deserializer) {
    ...
    return AdmissionSession(sessionId: var_sessionId, challenge: var_challenge);
  }
  ...
  AdmissionSession sse_decode_box_autoadd_admission_session(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_admission_session(deserializer));
  }
  ...
  RegistrationChallenge sse_decode_box_autoadd_registration_challenge(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_registration_challenge(deserializer));
  }
  ...
  UiChatMuted sse_decode_box_autoadd_ui_chat_muted(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_ui_chat_muted(deserializer));
  }
  ...
  ChallengeKind sse_decode_challenge_kind(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return ChallengeKind.values[inner];
  }
  ...
  ChatsDelta sse_decode_chats_delta(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_upserted = sse_decode_list_ui_chat_details(deserializer);
    var var_removed = sse_decode_Set_chat_id_None(deserializer);
    var var_order = sse_decode_opt_list_chat_id(deserializer);
    var var_members = sse_decode_Map_chat_id_list_ui_user_id_None(deserializer);
    return ChatsDelta(
  ...
  CreateUserError sse_decode_create_user_error(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_accepted = sse_decode_list_challenge_kind(deserializer);
        return CreateUserError_ChallengeRequired(accepted: var_accepted);
      case 1:
        return CreateUserError_ChallengeRejected();
      case 2:
        var var_message = sse_decode_String(deserializer);
        return CreateUserError_Other(message: var_message);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  DbMigrationState sse_decode_db_migration_state(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return DbMigrationState.values[inner];
  }

  @protected
  DebugCapabilities sse_decode_debug_capabilities(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  LinkedDevicesState sse_decode_linked_devices_state(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_devices = sse_decode_list_ui_linked_device(deserializer);
    return LinkedDevicesState(devices: var_devices);
  }
  ...
  List<ChallengeKind> sse_decode_list_challenge_kind(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ChallengeKind>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_challenge_kind(deserializer));
    }
    return ans_;
  }
  ...
  List<MessageListChange> sse_decode_list_message_list_change(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_message_list_change(deserializer));
    }
    return ans_;
  }
  ...
  List<(ChatId, List<UiUserId>)> sse_decode_list_record_chat_id_list_ui_user_id(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <(ChatId, List<UiUserId>)>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_chat_id_list_ui_user_id(deserializer));
    }
    return ans_;
  }
  ...
  List<(int, DebugCapabilities)> sse_decode_list_record_u_32_debug_capabilities(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_u_32_debug_capabilities(deserializer));
    }
    return ans_;
  }
  ...
  List<TimedTaskDebugInfo> sse_decode_list_timed_task_debug_info(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_timed_task_debug_info(deserializer));
    }
    return ans_;
  }
  ...
  List<UiChatDetails> sse_decode_list_ui_chat_details(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <UiChatDetails>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_ui_chat_details(deserializer));
    }
    return ans_;
  }
  ...
  List<UiChatMessage> sse_decode_list_ui_chat_message(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_ui_chat_message(deserializer));
    }
    return ans_;
  }
  ...
  List<UiLinkedDevice> sse_decode_list_ui_linked_device(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <UiLinkedDevice>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_ui_linked_device(deserializer));
    }
    return ans_;
  }
  ...
  MessageListChange sse_decode_message_list_change(
    ...
    switch (tag_) {
      case 0:
        ...
        return MessageListChange_Reload(messages: var_messages);
      case 1:
        ...
        return MessageListChange_Splice(
          index: var_index,
          messages: var_messages,
          deleteCount: var_deleteCount,
        );
      case 2:
        var var_index = sse_decode_usize(deserializer);
        var var_message = sse_decode_box_autoadd_ui_chat_message(deserializer);
        return MessageListChange_Patch(index: var_index, message: var_message);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  MessageListCommand sse_decode_message_list_command(
    ...
    switch (tag_) {
      case 0:
        var var_messageId = sse_decode_box_autoadd_message_id(deserializer);
        return MessageListCommand_ScrollToId(messageId: var_messageId);
      case 1:
        return MessageListCommand_ScrollToBottom();
      default:
        throw UnimplementedError('');
  ...
  MessageListTransition sse_decode_message_list_transition(
    ...
    var var_command = sse_decode_opt_box_autoadd_message_list_command(
      deserializer,
    );
    return MessageListTransition(
      revision: var_revision,
  ...
  MultiDeviceProvisionEvent sse_decode_multi_device_provision_event(
    ...
    switch (tag_) {
      case 0:
        var var_qrcodeSvg = sse_decode_opt_String(deserializer);
        var var_code = sse_decode_String(deserializer);
        return MultiDeviceProvisionEvent_Code(
          qrcodeSvg: var_qrcodeSvg,
          code: var_code,
        );
      case 1:
        return MultiDeviceProvisionEvent_Linking();
  ...
  sse_decode_opt_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
        deserializer,
      ));
    } else {
      return null;
  ...
  sse_decode_opt_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
        deserializer,
      ));
    } else {
      return null;
  ...
  RegistrationChallenge? sse_decode_opt_box_autoadd_registration_challenge(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_registration_challenge(deserializer));
    } else {
      return null;
    }
  }
  ...
  sse_decode_opt_box_autoadd_request_invitation_code_error(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_request_invitation_code_error(
        deserializer,
      ));
    } else {
      return null;
  ...
  UiChatMuted? sse_decode_opt_box_autoadd_ui_chat_muted(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_ui_chat_muted(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  List<ChatId>? sse_decode_opt_list_chat_id(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_list_chat_id(deserializer));
    } else {
      return null;
    }
  }
  ...
  (ChatId, List<UiUserId>) sse_decode_record_chat_id_list_ui_user_id(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field0 = sse_decode_chat_id(deserializer);
    var var_field1 = sse_decode_list_ui_user_id(deserializer);
  ...
  RegistrationChallenge sse_decode_registration_challenge(
    ...
    switch (tag_) {
      case 0:
        var var_field0 = sse_decode_String(deserializer);
        return RegistrationChallenge_InvitationCode(var_field0);
      case 1:
        var var_field0 = sse_decode_box_autoadd_admission_session(deserializer);
        return RegistrationChallenge_AdmissionSession(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  RegistrationInfo sse_decode_registration_info(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_challengeRequired = sse_decode_bool(deserializer);
    var var_acceptedChallenges = sse_decode_list_challenge_kind(deserializer);
    return RegistrationInfo(
      challengeRequired: var_challengeRequired,
      acceptedChallenges: var_acceptedChallenges,
    );
  }
  ...
  UiAttachmentStatus sse_decode_ui_attachment_status(
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return UiAttachmentStatus_Progress(var_field0);
      case 2:
        return UiAttachmentStatus_Completed();
      case 3:
        return UiAttachmentStatus_Failed();
  ...
  UiChatMuted sse_decode_ui_chat_muted(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return UiChatMuted_Until(var_field0);
      case 1:
        return UiChatMuted_Forever();
      default:
        throw UnimplementedError('');
  ...
  UiChatType sse_decode_ui_chat_type(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_field0 = sse_decode_box_autoadd_ui_username(deserializer);
        return UiChatType_HandleConnection(var_field0);
      case 1:
        var var_field0 = sse_decode_box_autoadd_ui_user_profile(deserializer);
        return UiChatType_Connection(var_field0);
      case 2:
        var var_field0 = sse_decode_box_autoadd_ui_user_profile(deserializer);
  ...
  UiClientRecord sse_decode_ui_client_record(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_clientRecordId = sse_decode_Uuid(deserializer);
    ...
    return UiClientRecord(
      clientRecordId: var_clientRecordId,
      userId: var_userId,
      createdAt: var_createdAt,
  ...
  UiInReplyToMessage sse_decode_ui_in_reply_to_message(
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        var var_mimiContent = sse_decode_box_autoadd_ui_mimi_content(
          deserializer,
        );
        return UiInReplyToMessage_Resolved(
          messageId: var_messageId,
          sender: var_sender,
          mimiContent: var_mimiContent,
        );
      default:
        throw UnimplementedError('');
    }
  ...
  UiReaction sse_decode_ui_reaction(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_emoji = sse_decode_String(deserializer);
    var var_users = sse_decode_list_ui_user_id(deserializer);
    return UiReaction(emoji: var_emoji, users: var_users);
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerChatDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ChatDetailsCubitBaseImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerInvitationCodesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as InvitationCodesCubitBaseImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLinkedDevicesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LinkedDevicesCubitBaseImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MemberDetailsCubitBaseImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceLinkConfirmation(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MultiDeviceLinkConfirmationImpl).frbInternalSseEncode(
        move: true,
      ),
      serializer,
    );
  ...
  @protected
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    MultiDeviceProvisionedUser self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MultiDeviceProvisionedUserImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as UsernameHashImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerChatDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ChatDetailsCubitBaseImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerInvitationCodesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as InvitationCodesCubitBaseImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLinkedDevicesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LinkedDevicesCubitBaseImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MemberDetailsCubitBaseImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MultiDeviceProvisionedUserImpl).frbInternalSseEncode(
        move: false,
      ),
      serializer,
    );
  ...
  void sse_encode_Map_chat_id_list_ui_user_id_None(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_record_chat_id_list_ui_user_id(
  ...
  void sse_encode_Map_u_32_debug_capabilities_None(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_record_u_32_debug_capabilities(
      self.entries.map((e) => (e.key, e.value)).toList(),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerChatDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ChatDetailsCubitBaseImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerInvitationCodesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as InvitationCodesCubitBaseImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLinkedDevicesCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LinkedDevicesCubitBaseImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMemberDetailsCubitBase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MemberDetailsCubitBaseImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMultiDeviceProvisionedUser(
    MultiDeviceProvisionedUser self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as MultiDeviceProvisionedUserImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUsernameHash(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as UsernameHashImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  @protected
  void sse_encode_Set_chat_id_None(Set<ChatId> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_chat_id(self.toList(), serializer);
  }
  ...
  @protected
  void sse_encode_StreamSink_chats_delta_Sse(
    RustStreamSink<ChatsDelta> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(
      self.setupAndSerialize(
        codec: SseCodec(
          decodeSuccessData: sse_decode_chats_delta,
          decodeErrorData: sse_decode_AnyhowException,
        ),
      ),
      serializer,
  ...
  void sse_encode_StreamSink_db_migration_state_Sse(
    ...
    sse_encode_String(
      self.setupAndSerialize(
        codec: SseCodec(
          decodeSuccessData: sse_decode_db_migration_state,
          decodeErrorData: sse_decode_AnyhowException,
        ),
      ),
      serializer,
  ...
  void sse_encode_StreamSink_multi_device_link_event_Sse(
    ...
    sse_encode_String(
      self.setupAndSerialize(
        codec: SseCodec(
          decodeSuccessData: sse_decode_multi_device_link_event,
          decodeErrorData: sse_decode_AnyhowException,
        ),
      ),
      serializer,
  ...
  void sse_encode_box_autoadd_admission_session(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_admission_session(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_registration_challenge(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_registration_challenge(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_ui_chat_muted(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_ui_chat_muted(self, serializer);
  }
  ...
  void sse_encode_chats_delta(ChatsDelta self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_ui_chat_details(self.upserted, serializer);
  ...
  void sse_encode_create_user_error(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case CreateUserError_ChallengeRequired(accepted: final accepted):
        sse_encode_i_32(0, serializer);
        sse_encode_list_challenge_kind(accepted, serializer);
      case CreateUserError_ChallengeRejected():
        sse_encode_i_32(1, serializer);
      case CreateUserError_Other(message: final message):
        sse_encode_i_32(2, serializer);
        sse_encode_String(message, serializer);
    }
  }
  ...
  void sse_encode_group_debug_info(
    ...
    sse_encode_opt_box_autoadd_required_debug_capabilities(
  ...
  void sse_encode_linked_devices_state(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_ui_linked_device(self.devices, serializer);
  }
  ...
  void sse_encode_list_challenge_kind(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_challenge_kind(item, serializer);
    }
  }
  ...
  void sse_encode_list_message_list_change(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_message_list_change(item, serializer);
    }
  }
  ...
  void sse_encode_list_record_chat_id_list_ui_user_id(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_chat_id_list_ui_user_id(item, serializer);
    }
  }
  ...
  void sse_encode_list_record_u_32_debug_capabilities(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_u_32_debug_capabilities(item, serializer);
    }
  }
  ...
  void sse_encode_list_timed_task_debug_info(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_timed_task_debug_info(item, serializer);
    }
  }
  ...
  void sse_encode_list_ui_chat_details(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_ui_chat_details(item, serializer);
    }
  }
  ...
  void sse_encode_list_ui_chat_message(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_ui_chat_message(item, serializer);
    }
  }
  ...
  void sse_encode_list_ui_linked_device(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_ui_linked_device(item, serializer);
    }
  }
  ...
  void sse_encode_list_ui_username(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_ui_username(item, serializer);
    }
  }
  ...
  void sse_encode_message_list_command(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case MessageListCommand_ScrollToId(messageId: final messageId):
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_message_id(messageId, serializer);
  ...
  void sse_encode_opt_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
        self,
        serializer,
      );
    }
  ...
  void sse_encode_opt_box_autoadd_registration_challenge(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_registration_challenge(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_ui_chat_muted(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_ui_chat_muted(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_list_chat_id(
    List<ChatId>? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_list_chat_id(self, serializer);
    }
  }
  ...
  void sse_encode_record_chat_id_list_ui_user_id(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_chat_id(self.$1, serializer);
    sse_encode_list_ui_user_id(self.$2, serializer);
  }
  ...
  void sse_encode_registration_challenge(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case RegistrationChallenge_InvitationCode(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_String(field0, serializer);
      case RegistrationChallenge_AdmissionSession(field0: final field0):
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_admission_session(field0, serializer);
    }
  }
  ...
  void sse_encode_registration_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bool(self.challengeRequired, serializer);
    sse_encode_list_challenge_kind(self.acceptedChallenges, serializer);
  }
  ...
  void sse_encode_ui_attachment_status(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case UiAttachmentStatus_Pending():
        sse_encode_i_32(0, serializer);
      case UiAttachmentStatus_Progress(field0: final field0):
        sse_encode_i_32(1, serializer);
        sse_encode_usize(field0, serializer);
      case UiAttachmentStatus_Completed():
        sse_encode_i_32(2, serializer);
  ...
  @protected
  void sse_encode_ui_chat_details(
    UiChatDetails self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_ui_chat_message(
    UiChatMessage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_opt_box_autoadd_ui_in_reply_to_message(
  ...
  void sse_encode_ui_chat_muted(UiChatMuted self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case UiChatMuted_Until(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_Chrono_Utc(field0, serializer);
      case UiChatMuted_Forever():
        sse_encode_i_32(1, serializer);
    }
  }
  ...
  void sse_encode_ui_chat_type(UiChatType self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case UiChatType_HandleConnection(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_ui_username(field0, serializer);
      case UiChatType_Connection(field0: final field0):
        sse_encode_i_32(1, serializer);
  ...
  void sse_encode_ui_client_record(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_Uuid(self.clientRecordId, serializer);
  ...
  void sse_encode_ui_in_reply_to_message(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case UiInReplyToMessage_NotFound():
        sse_encode_i_32(0, serializer);
      case UiInReplyToMessage_Resolved(
        messageId: final messageId,
        sender: final sender,
        mimiContent: final mimiContent,
      ):
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_message_id(messageId, serializer);
  ...
  void sse_encode_ui_message_draft(
    ...
    sse_encode_opt_box_autoadd_record_ui_mimi_id_ui_in_reply_to_message(
      self.inReplyTo,
      serializer,
    );
  ...
  @protected
  void sse_encode_user_debug_info(
    UserDebugInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
...
@sealed
class ChatDetailsCubitBaseImpl extends RustOpaque
    implements ChatDetailsCubitBase {
  // Not to be used by end users
  ChatDetailsCubitBaseImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  ChatDetailsCubitBaseImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_ChatDetailsCubitBase,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_ChatDetailsCubitBase,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
  ...
  Future<GroupDebugInfo> chatDebugInfo() => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseChatDebugInfo(that: this);
  ...
  Future<void> deleteReaction({
    ...
    required String emoji,
      ...
      .crateApiChatDetailsCubitChatDetailsCubitBaseDeleteReaction(
        that: this,
        messageId: messageId,
        emoji: emoji,
      );

  Future<void> devUpdateApqKey() => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateApqKey(that: this);

  Future<void> devUpdateKey() => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseDevUpdateKey(that: this);
  ...
  bool get isClosed => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseIsClosed(that: this);
  ...
  Future<void> markAsRead({
    ...
    required DateTime untilTimestamp,
      ...
      .crateApiChatDetailsCubitChatDetailsCubitBaseMarkAsRead(
        that: this,
  ...
  Future<void> replyToMessage({required MessageId messageId}) => RustLib
      .instance
      .api
      .crateApiChatDetailsCubitChatDetailsCubitBaseReplyToMessage(
        that: this,
        messageId: messageId,
      );

  Future<void> requestResync() => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseRequestResync(that: this);

  Future<void> resetDraft() => RustLib.instance.api
      .crateApiChatDetailsCubitChatDetailsCubitBaseResetDraft(that: this);

  Future<void> resetDraftReply() => RustLib.instance.api
  ...
  Future<void> sendMessage({required String messageText}) => RustLib
      .instance
      .api
      .crateApiChatDetailsCubitChatDetailsCubitBaseSendMessage(
        that: this,
  ...
  Future<void> sendReaction({
    ...
    required String emoji,
      ...
      .crateApiChatDetailsCubitChatDetailsCubitBaseSendReaction(
        that: this,
        messageId: messageId,
        emoji: emoji,
      );
...
@sealed
class InvitationCodesCubitBaseImpl extends RustOpaque
    implements InvitationCodesCubitBase {
  // Not to be used by end users
  InvitationCodesCubitBaseImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  InvitationCodesCubitBaseImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_InvitationCodesCubitBase,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_InvitationCodesCubitBase,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_InvitationCodesCubitBasePtr,
  );

  Future<void> clearCopiedCodes() => RustLib.instance.api
      .crateApiInvitationCodesCubitInvitationCodesCubitBaseClearCopiedCodes(
        that: this,
      );

  Future<void> close() => RustLib.instance.api
      .crateApiInvitationCodesCubitInvitationCodesCubitBaseClose(that: this);
  ...
  InvitationCodesState get state => RustLib.instance.api
      .crateApiInvitationCodesCubitInvitationCodesCubitBaseState(that: this);

  Stream<InvitationCodesState> stream() => RustLib.instance.api
      .crateApiInvitationCodesCubitInvitationCodesCubitBaseStream(that: this);
}

@sealed
class LinkedDevicesCubitBaseImpl extends RustOpaque
    implements LinkedDevicesCubitBase {
  // Not to be used by end users
  LinkedDevicesCubitBaseImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  LinkedDevicesCubitBaseImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_LinkedDevicesCubitBase,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_LinkedDevicesCubitBase,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_LinkedDevicesCubitBasePtr,
  );

  Future<void> close() => RustLib.instance.api
      .crateApiLinkedDevicesCubitLinkedDevicesCubitBaseClose(that: this);
...
@sealed
class MemberDetailsCubitBaseImpl extends RustOpaque
    implements MemberDetailsCubitBase {
  // Not to be used by end users
  MemberDetailsCubitBaseImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  MemberDetailsCubitBaseImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_MemberDetailsCubitBase,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_MemberDetailsCubitBase,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_MemberDetailsCubitBasePtr,
  );

  Future<void> close() => RustLib.instance.api
      .crateApiMemberDetailsCubitMemberDetailsCubitBaseClose(that: this);

  bool get isClosed => RustLib.instance.api
      .crateApiMemberDetailsCubitMemberDetailsCubitBaseIsClosed(that: this);

  MemberDetailsState get state => RustLib.instance.api
      .crateApiMemberDetailsCubitMemberDetailsCubitBaseState(that: this);

  Stream<MemberDetailsState> stream() => RustLib.instance.api
      .crateApiMemberDetailsCubitMemberDetailsCubitBaseStream(that: this);
}
...
class MessageListCubitBaseImpl extends RustOpaque
  ...
  Future<void> jumpToBottom() => RustLib.instance.api
      .crateApiMessageListCubitMessageListCubitBaseJumpToBottom(that: this);

  /// Jump to a specific message (loads a window around it if not in view).
  Future<void> jumpToMessage({required MessageId messageId}) => RustLib
      .instance
      .api
      .crateApiMessageListCubitMessageListCubitBaseJumpToMessage(
        that: this,
        messageId: messageId,
      );

  /// Request loading of newer messages (append to window).
  Future<void> loadNewer() => RustLib.instance.api
      .crateApiMessageListCubitMessageListCubitBaseLoadNewer(that: this);

  /// Request loading of older messages (prepend to window).
  Future<void> loadOlder() => RustLib.instance.api
      .crateApiMessageListCubitMessageListCubitBaseLoadOlder(that: this);
  ...
  Stream<MessageListTransition> transitions() => RustLib.instance.api
      .crateApiMessageListCubitMessageListCubitBaseTransitions(that: this);
}

@sealed
class MultiDeviceLinkConfirmationImpl extends RustOpaque
    implements MultiDeviceLinkConfirmation {
  // Not to be used by end users
  MultiDeviceLinkConfirmationImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  MultiDeviceLinkConfirmationImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_MultiDeviceLinkConfirmation,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_MultiDeviceLinkConfirmation,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
...
@sealed
class MultiDeviceProvisionedUserImpl extends RustOpaque
    implements MultiDeviceProvisionedUser {
  // Not to be used by end users
  MultiDeviceProvisionedUserImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  MultiDeviceProvisionedUserImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_MultiDeviceProvisionedUser,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_MultiDeviceProvisionedUser,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_MultiDeviceProvisionedUserPtr,
  );

  User? take() => RustLib.instance.api
      .crateApiMultiDeviceMultiDeviceProvisionedUserTake(that: this);
}
...
class UiRoomStateImpl extends RustOpaque implements UiRoomState {
  ...
  bool canKick({required UiUserId target}) => RustLib.instance.api
      .crateApiMemberDetailsCubitUiRoomStateCanKick(that: this, target: target);
}
...
class UserCubitBaseImpl extends RustOpaque implements UserCubitBase {
  ...
  Future<bool> addUsername({required UiUsername username}) =>
      RustLib.instance.api.crateApiUserCubitUserCubitBaseAddUsername(
        that: this,
        username: username,
      );
  ...
  Future<void> blockContact({required UiUserId userId}) => RustLib.instance.api
      .crateApiUserCubitUserCubitBaseBlockContact(that: this, userId: userId);

  Future<UsernameHash?> checkUsernameExists({required UiUsername username}) =>
      RustLib.instance.api.crateApiUserCubitUserCubitBaseCheckUsernameExists(
        that: this,
        username: username,
      );
  ...
  Future<UiContact?> contact({required UiUserId userId}) => RustLib.instance.api
      .crateApiUserCubitUserCubitBaseContact(that: this, userId: userId);
  ...
  Future<void> devEraseChat(ChatId chatId) => RustLib.instance.api
      .crateApiUserCubitUserCubitBaseDevEraseChat(that: this, chatId: chatId);

  bool get isClosed =>
      RustLib.instance.api.crateApiUserCubitUserCubitBaseIsClosed(that: this);

  Future<void> leaveChat(ChatId chatId) => RustLib.instance.api
      .crateApiUserCubitUserCubitBaseLeaveChat(that: this, chatId: chatId);
  ...
  String? parseMultiDeviceLinkingUrl({required String url}) => RustLib
      .instance
      .api
      .crateApiUserCubitUserCubitBaseParseMultiDeviceLinkingUrl(
        that: this,
        url: url,
      );

  Future<void> removeUserFromChat(ChatId chatId, UiUserId userId) =>
      RustLib.instance.api.crateApiUserCubitUserCubitBaseRemoveUserFromChat(
        that: this,
        chatId: chatId,
        userId: userId,
      );
  ...
  Future<void> removeUsername({required UiUsername username}) =>
      RustLib.instance.api.crateApiUserCubitUserCubitBaseRemoveUsername(
        that: this,
        username: username,
      );
  ...
  Future<void> unblockContact({required UiUserId userId}) => RustLib
      .instance
      .api
      .crateApiUserCubitUserCubitBaseUnblockContact(that: this, userId: userId);

  Future<String> uploadLogs({required String cacheDir}) => RustLib.instance.api
      .crateApiUserCubitUserCubitBaseUploadLogs(that: this, cacheDir: cacheDir);
}
...
class UserImpl extends RustOpaque implements User {
  ...
  void signalPendingStoreNotifications() => RustLib.instance.api
      .crateApiUserUserSignalPendingStoreNotifications(that: this);

  /// Force a timed task to run as soon as possible.
  Future<void> triggerTimedTask(List<int> id) =>
      RustLib.instance.api.crateApiUserUserTriggerTimedTask(that: this, id: id);
  ...
  Future<UserDebugInfo> userDebugInfo() =>
      RustLib.instance.api.crateApiUserUserUserDebugInfo(that: this);
...
class UserSettingsCubitBaseImpl extends RustOpaque
  ...
  Future<void> setDefaultEmojiSkinTone({required int value}) => RustLib
      .instance
      .api
      .crateApiUserSettingsCubitUserSettingsCubitBaseSetDefaultEmojiSkinTone(
        that: this,
  ...
  Future<void> setLocale({required String value}) => RustLib.instance.api
      .crateApiUserSettingsCubitUserSettingsCubitBaseSetLocale(
        that: this,
        value: value,
      );

  Future<void> setReadReceipts({required bool value}) => RustLib.instance.api
      .crateApiUserSettingsCubitUserSettingsCubitBaseSetReadReceipts(
        that: this,
        value: value,
      );

  Future<void> setSendOnEnter({required bool value}) => RustLib.instance.api
      .crateApiUserSettingsCubitUserSettingsCubitBaseSetSendOnEnter(
        that: this,
        value: value,
      );

  Future<void> setSidebarWidth({required double value}) => RustLib.instance.api
...
@sealed
class UsernameHashImpl extends RustOpaque implements UsernameHash {
  // Not to be used by end users
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_UsernameHash,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_UsernameHash,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_UsernameHashPtr,
  );
}
