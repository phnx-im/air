...
TextSpan buildSystemMessageText(
  ...
  return switch (message) {
    ...
    UiSystemMessage_DeviceAdded(:final field0) => switch (deviceNameOf(field0)) {
      final String deviceName => emphasizedText(
        (marks) => loc.systemMessage_deviceAdded(marks[0]),
        [EmphasizedValue(deviceName)],
        nameStyle,
      ),
      null => TextSpan(text: loc.systemMessage_deviceAddedUnknown),
    },
  };
}
