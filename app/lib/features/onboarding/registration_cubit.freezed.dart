...
@override
int get hashCode => Object.hash(runtimeType,domain,avatar,displayName,isSigningUp,isCheckingInvitationCode,invitationCode,registrationInfo);

@override
String toString() {
  return 'RegistrationState(domain: $domain, avatar: $avatar, displayName: $displayName, isSigningUp: $isSigningUp, isCheckingInvitationCode: $isCheckingInvitationCode, invitationCode: $invitationCode, registrationInfo: $registrationInfo)';
}
...
@useResult
$Res call({
 String domain, ImageData? avatar, String displayName, bool isSigningUp, bool isCheckingInvitationCode, String? invitationCode, RegistrationInfo? registrationInfo
});
...
/// Create a copy of RegistrationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? domain = null,Object? avatar = freezed,Object? displayName = null,Object? isSigningUp = null,Object? isCheckingInvitationCode = null,Object? invitationCode = freezed,Object? registrationInfo = freezed,}) {
...
class _RegistrationState extends RegistrationState {
  const _RegistrationState({this.domain = 'air.ms', this.avatar, this.displayName = '', this.isSigningUp = false, this.isCheckingInvitationCode = false, this.invitationCode, this.registrationInfo}): super._();
...
/// Create a copy of RegistrationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? domain = null,Object? avatar = freezed,Object? displayName = null,Object? isSigningUp = null,Object? isCheckingInvitationCode = null,Object? invitationCode = freezed,Object? registrationInfo = freezed,}) {
